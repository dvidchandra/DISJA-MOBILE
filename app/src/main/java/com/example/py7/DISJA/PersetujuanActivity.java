...
import com.example.py7.DISJA.adapters.CustomCursorAdapter;
import com.example.py7.DISJA.adapters.DBHelper;

public class PersetujuanActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PersetujuanActivity.this, AddActivity.class));
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_lamaran, menu);
        return true;
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long I) {
        ...
        Intent idpinjam = new Intent(PersetujuanActivity.this, AddActivity.class);
